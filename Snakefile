...
rule all:
    input:
        expand(temp({out_dir}/kraken2_{sra_id}.report),sra_id=SRA_ID,out_dir=OUT_DIR),
        expand(temp({out_dir}/kraken2_output_{sra_id}.report),sra_id=SRA_ID,out_dir=OUT_DIR),
